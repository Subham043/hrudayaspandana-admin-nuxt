                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <NuxtLink to="/gallery/images/create"><el-button type="warning">Create</el-button></NuxtLink>
                            </div>
                        </div>
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                ...
                                <el-table-column fixed="right" label="Operations" width="200">
                                    <template slot-scope="scope">
                                      <el-tooltip class="item" effect="dark" content="Edit Images" placement="top-start">
                                        <NuxtLink :to="`/gallery/images/edit/${scope.row.id}`"><el-button type="primary" icon="el-icon-edit" circle></el-button></NuxtLink>
                                      </el-tooltip>
                                      <el-tooltip class="item" effect="dark" content="Display Images" placement="top-start">
                                        <NuxtLink :to="`/gallery/images/display/${scope.row.id}`"><el-button type="info" icon="el-icon-view" circle></el-button></NuxtLink>
                                      </el-tooltip>
                                      <el-tooltip class="item" effect="dark" content="Delete Images" placement="top-start">
                                        <el-popconfirm
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/api/gallery-image/paginate?page='+page); // eslint-disable-line
        ...
        async deleteRow(id){
            ...
            try {
                ...
                const response = await this.$privateApi.delete('/api/gallery-image/delete/'+id);
