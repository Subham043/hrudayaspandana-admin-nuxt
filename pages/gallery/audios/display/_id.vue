<template>
    <div>
        <BreadcrumbComponent main-page="Audios" current-page="Display" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Display Audios</h4>
                        </div>
                        <!-- /.box-header -->
                        ...
                        <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <ValidationProvider v-slot="{ classes, errors }" rules="required|ext:wav,mp3,aac" name="image">
                                        <div class="form-group">
    ...
    methods: {
        ...
        async checkId(){
            ...
            if(!this.$route.params.id){
                ...
                this.$router.push('/gallery/audios/list');
            }
            try {
