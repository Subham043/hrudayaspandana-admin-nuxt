<template>
    <div>
        <BreadcrumbComponent main-page="Audio" current-page="Create" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Create Audio</h4>
                        </div>
                        <!-- /.box-header -->
                        <ValidationObserver ref="form" v-slot="{ handleSubmit }">
                        <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                <h4 class="box-title text-primary mb-0"><i class="el-icon-user"></i> Audio Info</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <ValidationProvider v-slot="{ classes, errors }" rules="required|ext:wav,mp3,aac" name="audio">
                                        <div class="form-group">
                            ...
                            <div class="box-footer">
                                <NuxtLink to="/gallery/audios/list"><button type="button" class="btn btn-primary-light me-1">
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/gallery-audio/create', formData); // eslint-disable-line
