<template>
    <div>
        <BreadcrumbComponent main-page="Volunteer" current-page="List" />
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                ...
                                <el-table-column prop="aadhar" label="Aadhar" width="250">
                                </el-table-column>
                                ...
                                <el-table-column prop="interest" label="Interest" width="150">
                                </el-table-column>
                                <el-table-column fixed="right" label="Operations" width="100">
                                    <template slot-scope="scope">
                                      <el-tooltip class="item" effect="dark" content="Delete Volunteer" placement="top-start">
                                        <el-popconfirm
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/api/volunteer/paginate?page='+page); // eslint-disable-line
        ...
        async deleteRow(id){
            ...
            try {
                ...
                const response = await this.$privateApi.delete('/api/volunteer/delete/'+id);
        ...
        async downloadExcel(){
            ...
            try {
                // eslint-disable-next-line no-unused-vars
                const response = await this.$privateApi.get('/api/volunteer/excel');
