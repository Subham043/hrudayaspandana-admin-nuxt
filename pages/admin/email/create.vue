<template>
    <div>
        <BreadcrumbComponent main-page="Email" current-page="Create" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Create Email</h4>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div v-if="attachment" class="col-md-6">
                                        <ValidationProvider v-slot="{ classes, errors }" rules="required|ext:jpg,jpeg,webp,png,pdf" name="file">
                                        <div class="form-group">
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/email/create', formData); // eslint-disable-line
