<template>
    <div>
        <BreadcrumbComponent main-page="Videos" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Videos</h4>
                        </div>
                        <!-- /.box-header -->
                        <ValidationObserver ref="form" v-slot="{ handleSubmit }">
                        <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                <h4 class="box-title text-primary mb-0"><i class="el-icon-user"></i> Videos Info</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-6">
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/gallery-video/edit/'+this.$route.params.id, formData); // eslint-disable-line
        ...
        async checkId(){
            ...
            if(!this.$route.params.id){
                ...
                this.$router.push('/admin/gallery/videos/list');
            }
            try {
