<template>
    <div>
        <BreadcrumbComponent main-page="Media" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Media</h4>
                        </div>
                        <!-- /.box-header -->
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/media/edit/'+this.$route.params.id, formData); // eslint-disable-line
