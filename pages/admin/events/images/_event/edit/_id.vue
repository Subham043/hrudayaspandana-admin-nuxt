<template>
    <div>
        <BreadcrumbComponent main-page="Images" current-page="Edit" />
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/event/gallery/image/'+this.$route.params.event+'/edit/'+this.$route.params.id, formData); // eslint-disable-line
