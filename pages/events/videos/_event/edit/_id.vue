<template>
    <div>
        <BreadcrumbComponent main-page="Event Videos" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Event Videos</h4>
                        </div>
                        <!-- /.box-header -->
                        <ValidationObserver ref="form" v-slot="{ handleSubmit }">
                        <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                <h4 class="box-title text-primary mb-0"><i class="el-icon-user"></i> Event Videos Info</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-12">
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/api/event/gallery/video/'+this.$route.params.event+'/edit/'+this.$route.params.id, formData); // eslint-disable-line
