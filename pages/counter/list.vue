<template>
    <div>
        <BreadcrumbComponent main-page="Counter" current-page="List" />
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header d-flex justify-content-between align-items-center">
                            <h4 class="box-title">Counter</h4>
                            <div>
                                <NuxtLink to="/counter/create"><el-button type="warning">Create</el-button></NuxtLink>
                            </div>
                        </div>
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                ...
                                <el-table-column prop="counter" label="Counter">
                                </el-table-column>
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/api/counter/paginate?page='+page); // eslint-disable-line
        ...
        async deleteRow(id){
            ...
            try {
                ...
                const response = await this.$privateApi.delete('/api/counter/delete/'+id);
